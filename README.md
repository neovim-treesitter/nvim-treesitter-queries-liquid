# nvim-treesitter-queries-liquid

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-liquid/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-liquid/actions/workflows/validate.yml)

Neovim tree-sitter queries for **liquid**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-liquid",
...
- [ ] Changes are scoped to `liquid` — do not include files for other languages
